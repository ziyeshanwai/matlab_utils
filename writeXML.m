...
IntrinsicMatrix = (cameraParam.IntrinsicMatrix)'; %相机内参矩阵
RadialDistortion = cameraParam.RadialDistortion; %相机径向畸变参数向量1*3
TangentialDistortion =cameraParam.TangentialDistortion; %相机切向畸变向量1*2
